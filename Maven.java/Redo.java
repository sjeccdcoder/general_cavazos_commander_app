...
public class Menu
{
    ...
    lp : while(true) //labelling the while loop
    {
        ...
        switch (ch)
        {
            ...
            System.out.println("-----------------------------------------------------");
            break;
            case 3 :// Issue Command
            System.out.println("[COMMAND ISSUED]: General Cavazos orders the troops to do: Open Ranks");
            System.out.println("-----------------------------------------------------");
            System.out.println("General Cavazos Commander App");
            System.out.println("-----------------------------------------------------");
            break;
            case 4 ://undo the last Command
            System.out.println("[Command to UNDO]: Open Ranks");
            System.out.println("-----------------------------------------------------");
            System.out.println("General Cavazos Commander App");
            System.out.println("-----------------------------------------------------");
            break;
            case 5 :// Redo the last Command
            System.out.println("[Command to REDO]: There are no commands to redo. Please issue or redo a command");
            System.out.println("-----------------------------------------------------");
            System.out.println("General Cavazos Commander App");
            System.out.println("-----------------------------------------------------");
            break;
